...
INSERT INTO `vc_chat`.`users` (`id`, `username`, `password`, `nickname`, `avatar`, `enabled`) VALUES ('2', 'admin2', 'e10adc3949ba59abbe56e057f20f883e', 'admin2', '/webjars/adminlte/2.3.6/dist/img/user2-160x160.jpg', '1');
