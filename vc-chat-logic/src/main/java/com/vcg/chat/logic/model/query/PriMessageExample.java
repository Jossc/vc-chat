...
public class PriMessageExample extends BaseExample<PriMessageExample,PriMessageExample.Criteria> implements Serializable {
    ...
    public static class Columns extends ArrayList<String> {
		 ...
		 public Columns andSendId() {
			add(sendId);
			return this;
		}

		 public Columns andRecId() {
			add(recId);
			return this;
		}
    ...
    public PriMessageExample withDistinct(boolean distinct){
